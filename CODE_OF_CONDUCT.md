...
- Respect that dietary choices — vegetarian, vegan, omnivore, religious, medical, budget-driven —
  are the contributor's own. This project exists precisely because one table holds several of them.
...
- Presenting nutritional claims as medical advice, or pushing unsourced health claims.
- Publishing anyone's private information.
- Sustained disruption of discussions or reviews.

## Scope

Applies to issues, pull requests, discussions, commit messages and any project space, including when
